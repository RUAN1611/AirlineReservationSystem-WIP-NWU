...
namespace AirlineReservationSystem.DataAccess.Migrations
{
    ...
    [Migration("20230719164337_EditTicketTableAndSeed")]
    partial class EditTicketTableAndSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AirlineReservationSystem.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 2,
                            DateCreated = new DateTime(2023, 7, 19, 19, 43, 37, 181, DateTimeKind.Local).AddTicks(4445),
                            FlightId = 3,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 2,
                            CustomerId = 3,
                            DateCreated = new DateTime(2023, 7, 19, 19, 43, 37, 181, DateTimeKind.Local).AddTicks(4486),
                            FlightId = 1,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 3,
                            CustomerId = 4,
                            DateCreated = new DateTime(2023, 7, 19, 19, 43, 37, 181, DateTimeKind.Local).AddTicks(4488),
                            FlightId = 2,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 4,
                            CustomerId = 5,
                            DateCreated = new DateTime(2023, 7, 19, 19, 43, 37, 181, DateTimeKind.Local).AddTicks(4490),
                            FlightId = 4,
                            Status = "Reserved"
                        });
                });

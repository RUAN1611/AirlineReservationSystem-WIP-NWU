...
namespace AirlineReservationSystem.DataAccess.Migrations
{
    ...
    [Migration("20230716100227_AddReservationTableAndSeed")]
    partial class AddReservationTableAndSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AirlineReservationSystem.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 2,
                            DateCreated = new DateTime(2023, 7, 16, 13, 2, 27, 195, DateTimeKind.Local).AddTicks(2524),
                            FlightId = 3,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 2,
                            CustomerId = 3,
                            DateCreated = new DateTime(2023, 7, 16, 13, 2, 27, 195, DateTimeKind.Local).AddTicks(2564),
                            FlightId = 1,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 3,
                            CustomerId = 4,
                            DateCreated = new DateTime(2023, 7, 16, 13, 2, 27, 195, DateTimeKind.Local).AddTicks(2566),
                            FlightId = 2,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 4,
                            CustomerId = 5,
                            DateCreated = new DateTime(2023, 7, 16, 13, 2, 27, 195, DateTimeKind.Local).AddTicks(2568),
                            FlightId = 4,
                            Status = "Reserved"
                        });
                });

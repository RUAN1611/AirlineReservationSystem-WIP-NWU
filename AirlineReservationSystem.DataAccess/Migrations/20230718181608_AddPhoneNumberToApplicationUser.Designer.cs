...
namespace AirlineReservationSystem.DataAccess.Migrations
{
    ...
    [Migration("20230718181608_AddPhoneNumberToApplicationUser")]
            ...
            modelBuilder.Entity("AirlineReservationSystem.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 2,
                            DateCreated = new DateTime(2023, 7, 18, 21, 16, 7, 853, DateTimeKind.Local).AddTicks(4225),
                            FlightId = 3,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 2,
                            CustomerId = 3,
                            DateCreated = new DateTime(2023, 7, 18, 21, 16, 7, 853, DateTimeKind.Local).AddTicks(4278),
                            FlightId = 1,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 3,
                            CustomerId = 4,
                            DateCreated = new DateTime(2023, 7, 18, 21, 16, 7, 853, DateTimeKind.Local).AddTicks(4280),
                            FlightId = 2,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 4,
                            CustomerId = 5,
                            DateCreated = new DateTime(2023, 7, 18, 21, 16, 7, 853, DateTimeKind.Local).AddTicks(4282),
                            FlightId = 4,
                            Status = "Reserved"
                        });
                });

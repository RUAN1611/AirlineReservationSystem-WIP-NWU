...
namespace AirlineReservationSystem.DataAccess.Migrations
{
    ...
    [Migration("20230718133941_AddIdentityTables")]
            ...
            modelBuilder.Entity("AirlineReservationSystem.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 2,
                            DateCreated = new DateTime(2023, 7, 18, 16, 39, 41, 420, DateTimeKind.Local).AddTicks(4934),
                            FlightId = 3,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 2,
                            CustomerId = 3,
                            DateCreated = new DateTime(2023, 7, 18, 16, 39, 41, 420, DateTimeKind.Local).AddTicks(4981),
                            FlightId = 1,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 3,
                            CustomerId = 4,
                            DateCreated = new DateTime(2023, 7, 18, 16, 39, 41, 420, DateTimeKind.Local).AddTicks(4983),
                            FlightId = 2,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 4,
                            CustomerId = 5,
                            DateCreated = new DateTime(2023, 7, 18, 16, 39, 41, 420, DateTimeKind.Local).AddTicks(4985),
                            FlightId = 4,
                            Status = "Reserved"
                        });
                });

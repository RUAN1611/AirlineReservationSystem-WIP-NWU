...
namespace AirlineReservationSystem.DataAccess.Migrations
{
    ...
    [Migration("20230718180934_ExtendIdentityUser")]
            ...
            modelBuilder.Entity("AirlineReservationSystem.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 2,
                            DateCreated = new DateTime(2023, 7, 18, 21, 9, 34, 746, DateTimeKind.Local).AddTicks(6788),
                            FlightId = 3,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 2,
                            CustomerId = 3,
                            DateCreated = new DateTime(2023, 7, 18, 21, 9, 34, 746, DateTimeKind.Local).AddTicks(6836),
                            FlightId = 1,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 3,
                            CustomerId = 4,
                            DateCreated = new DateTime(2023, 7, 18, 21, 9, 34, 746, DateTimeKind.Local).AddTicks(6838),
                            FlightId = 2,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 4,
                            CustomerId = 5,
                            DateCreated = new DateTime(2023, 7, 18, 21, 9, 34, 746, DateTimeKind.Local).AddTicks(6840),
                            FlightId = 4,
                            Status = "Reserved"
                        });
                });

...
namespace AirlineReservationSystem.DataAccess.Migrations
{
    ...
    [Migration("20230718134551_AddApplicationUserTable")]
            ...
            modelBuilder.Entity("AirlineReservationSystem.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 2,
                            DateCreated = new DateTime(2023, 7, 18, 16, 45, 51, 211, DateTimeKind.Local).AddTicks(3469),
                            FlightId = 3,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 2,
                            CustomerId = 3,
                            DateCreated = new DateTime(2023, 7, 18, 16, 45, 51, 211, DateTimeKind.Local).AddTicks(3515),
                            FlightId = 1,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 3,
                            CustomerId = 4,
                            DateCreated = new DateTime(2023, 7, 18, 16, 45, 51, 211, DateTimeKind.Local).AddTicks(3517),
                            FlightId = 2,
                            Status = "Reserved"
                        },
                        new
                        {
                            Id = 4,
                            CustomerId = 5,
                            DateCreated = new DateTime(2023, 7, 18, 16, 45, 51, 211, DateTimeKind.Local).AddTicks(3519),
                            FlightId = 4,
                            Status = "Reserved"
                        });
                });
